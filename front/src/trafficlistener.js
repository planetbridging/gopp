...
class TrafficListener extends Component {
    ...
    constructor(props) {
      ...
      componentDidMount() {
        var webSockUrl = this.props.webSockUrl + "/traffic";
  ...
  aggregatePortData(device) {
    //var portTrafficData = this.props.portTrafficData;
...
export default TrafficListener;
